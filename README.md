...
`Match`, milliseconds, measured on GitHub Actions ubuntu-latest (4-vCPU AMD EPYC 9V74 80-Core Processor, linux/amd64).
...
|---|---|---|---|---|---|
| Window 1600×1000 · button 96×32 | 188.0 | 53.6 | 26.9 | 43.6 | **22.7** |
| Window 1600×1000 · icon 24×24 | 149.6 | 45.3 | 21.6 | 37.7 | **19.4** |
| Window 1600×1000 · panel 300×200 | 164.5 | 60.2 | 57.8 | 49.6 | **46.7** |
| Noise 1280×720 · sub 96×96 | 123.5 | 44.4 | 25.8 | 34.9 | **22.4** |
| Noise 1920×1080 · sub 128×128 | 292.2 | 79.8 | 40.2 | 62.6 | **35.3** |
| Noise 1920×1080 · sub 32×32 | 194.1 | 61.7 | 28.9 | 50.2 | **25.1** |
| Noise 640×480 · varying alpha, 4ch | 30.5 | 14.5 | 9.0 | 12.8 | **8.4** |
| Window 3840×2160 · button 96×32 | 871.3 | 271.1 | 129.8 | 224.6 | **109.6** |
| Noise 3840×2160 · sub 256×256 | 1267.9 | 384.5 | 206.0 | 296.1 | **176.7** |
| fruits 512×480 · sub 80×80 | 51.5 | 6.9 | 6.3 | 6.2 | **5.7** |
| baboon 512×512 · sub 64×64 | 33.3 | 7.4 | 6.6 | 6.3 | **5.8** |
| building 868×600 · sub 100×100 | 76.5 | 22.7 | 21.8 | 18.7 | **18.1** |
| graf1 800×640 · sub 120×120 | 91.6 | 23.4 | 22.0 | 18.9 | **18.3** |
| starry_night 752×600 · sub 128×128 | 67.4 | 21.7 | 22.2 | **18.2** | **18.2** |

`MatchGray` at 1080p/128 for scale: cgo 29.5 / 16.1 ms, pure-Go 21.9 / 12.7 ms (1T / 4T). Native C++ has no gray
...
**arm64** — the same `Match` matrix from the arm64 CI leg (GitHub Actions ubuntu-24.04-arm (4-vCPU Neoverse-N2, linux/arm64)). No native
...
|---|---|---|---|---|
| Window 1600×1000 · button 96×32 | 90.5 | 28.8 | 88.5 | **27.5** |
| Window 1600×1000 · icon 24×24 | 74.2 | **20.5** | 73.8 | **20.5** |
| Window 1600×1000 · panel 300×200 | 102.7 | 94.1 | 99.1 | **91.3** |
| Noise 1280×720 · sub 96×96 | 73.6 | **39.8** | 71.2 | 39.9 |
| Noise 1920×1080 · sub 128×128 | 132.8 | 49.6 | 129.4 | **48.8** |
| Noise 1920×1080 · sub 32×32 | 99.4 | **27.3** | 98.9 | 27.7 |
| Noise 640×480 · varying alpha, 4ch | 26.0 | **13.8** | 25.3 | 13.9 |
| Window 3840×2160 · button 96×32 | 458.2 | 124.0 | 453.7 | **123.6** |
| Noise 3840×2160 · sub 256×256 | 647.9 | 233.1 | 619.8 | **222.8** |
| fruits 512×480 · sub 80×80 | 11.4 | **10.4** | 11.6 | **10.4** |
| baboon 512×512 · sub 64×64 | 12.0 | 10.7 | 12.1 | **10.6** |
| building 868×600 · sub 100×100 | 38.7 | 36.2 | 38.2 | **36.1** |
| graf1 800×640 · sub 120×120 | 39.0 | 36.9 | 38.3 | **36.1** |
| starry_night 752×600 · sub 128×128 | 37.8 | 36.1 | 37.0 | **36.0** |

`MatchGray` at 1080p/128 on arm64: cgo 49.3 / 18.4 ms, pure-Go 46.7 / 18.2 ms (1T / 4T).
<!-- benchmatrix:end -->
