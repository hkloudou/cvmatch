...
`Match`, milliseconds, measured on GitHub Actions ubuntu-latest (4-vCPU INTEL(R) XEON(R) PLATINUM 8573C, linux/amd64).
...
pure Go 88.2 / 49.6 ms (1T / 4T). Native C++ has no gray
...
|---|---|---|---|---|
| Window 1600×1000 · button 96×32 | 89.2 | **29.0** | 217.1 | 65.3 |
| Window 1600×1000 · icon 24×24 | 74.6 | **22.4** | 177.9 | 47.7 |
| Window 1600×1000 · panel 300×200 | 99.9 | **93.6** | 246.4 | 228.0 |
| Noise 1280×720 · sub 96×96 | 73.2 | **40.2** | 181.0 | 98.8 |
| Noise 1920×1080 · sub 128×128 | 130.7 | **50.5** | 323.6 | 120.0 |
| Noise 1920×1080 · sub 32×32 | 100.1 | **30.2** | 236.9 | 64.6 |
| Noise 640×480 · varying alpha, 4ch | 26.1 | **14.2** | 63.5 | 34.1 |
| Window 3840×2160 · button 96×32 | 457.9 | **126.3** | 1117.1 | 299.7 |
| Noise 3840×2160 · sub 256×256 | 633.0 | **230.7** | 1588.0 | 549.9 |
| fruits 512×480 · sub 80×80 | 11.8 | **10.4** | 28.3 | 25.3 |
| baboon 512×512 · sub 64×64 | 12.2 | **10.7** | 29.4 | 26.2 |
| building 868×600 · sub 100×100 | 39.8 | **36.6** | 97.3 | 90.6 |
| graf1 800×640 · sub 120×120 | 39.2 | **37.1** | 98.4 | 93.7 |
| starry_night 752×600 · sub 128×128 | 38.1 | **36.4** | 94.7 | 91.5 |

`MatchGray` at 1080p/128 on arm64: asm 47.7 / 18.2 ms, pure Go 119.6 / 44.9 ms (1T / 4T).
<!-- benchmatrix:end -->
