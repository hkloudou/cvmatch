...
bench-charts GitHub workflow re-measures weekly and on demand
(workflow_dispatch) and commits the refreshed charts, benchdata.json and
README table.
...
def matrix_markdown():
    """The README 'full matrix' tables between the benchmatrix markers —
    one per architecture, identical shape."""
    lines = [
