...
// WORD streams — see _gen/kernels.S and generate.go). AArch64 keeps IEEE
// semantics by default (FPCR.FZ=0, round-to-nearest), so the kernels are
// bit-identical to the scalar loops, as on amd64.
