...
// targets the build stays kernel-free with or without the purego tag,
// test files included (codex caught a tag-only constraint breaking
// GOARCH=386 test compiles).
